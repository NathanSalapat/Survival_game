mobs:register_mob("animals:goat", {
	...
	visual = "mesh",
	mesh = "animals_goat.b3d",
	drawtype = "front",
	textures = {
		{"animals_goat_white.png"},
		{"animals_goat_brown.png"},
		{"animals_goat_grey.png"},
	},
	...
	drops = {
      ...
      {name = 'default:gold_lump', chance = 50, min = 1, max = 1},
	},
	-- damaged by
	water_damage = 1,
	lava_damage = 5,
...
mobs:register_spawn("animals:goat", {"default:dirt_with_grass", "ethereal:green_dirt_top"}, 20, 0, 20000, 1, 31000)
-- register spawn egg
mobs:register_egg("animals:goat", "Goat", "default_grass.png", 1)
