...
for _, col in pairs(all_colours) do
	...
	mobs:register_mob("animals:sheep_"..col[1], {
		type = "animal",
		passive = true,
		hp_min = 8,
		hp_max = 10,
		...
		textures = {
			{"animals_sheep_base.png^(animals_sheep_wool.png^[colorize:" .. col[3] .. ")"},
		},
		gotten_texture = {"animals_sheep_shaved.png"},
		gotten_mesh = "animals_sheep_shaved.b3d",
		makes_footstep_sound = true,
		sounds = {
			random = "animals_sheep",
		},
		walk_velocity = 1,
		run_velocity = 2,
		runaway = true,
		jump = true,
		drops = {
			{name = "food:steak_raw", chance = 1, min = 1, max = 4},
		...
		on_rightclick = function(self, clicker)
			...
			if mobs:feed_tame(self, clicker, 8, true, true) then
				...
				if self.gotten == false then
					...
					self.object:set_properties({
						textures = {"animals_sheep_base.png^(animals_sheep_wool.png^[colorize:" .. col[3] .. ")"},
						mesh = "animals_sheep.b3d",
					})
				end
			...
			if itemname == "animals:shears" then
				...
				self.object:set_properties({
					textures = {"animals_sheep_shaved.png"},
					mesh = "animals_sheep_shaved.b3d",
				})
				...
				and name == self.owner then
					...
					for _,c in pairs(all_colours) do
						...
						if c[1] == colr then
							...
							local mob = minetest.add_entity(pos, "animals:sheep_" .. colr)
	...
	mobs:register_egg("animals:sheep_"..col[1], col[2] .. " " .. S("Sheep"), "wool_"..col[1]..".png", 1)
end

mobs:register_spawn("animals:sheep_white",
